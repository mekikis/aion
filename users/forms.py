...
class UserForm(UserCreationForm):
    ...
    username = forms.EmailField(max_length=200, required=True, widget=forms.TextInput(attrs={'placeholder': '*Email..'}))
...
class UserProfileForm(forms.ModelForm):
    ...
    city = forms.CharField(max_length=40, required=True, widget=forms.HiddenInput())
